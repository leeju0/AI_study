...
"""
# 분석하고자 하는 컬럼의 유니크한 값 추출
unique_barcodes = df2['eml4_alk_translocation_performed'].unique()
print(unique_barcodes)
"""

# 분석하고자 하는 컬럼만 남기기
df2 = df2[['bcr_patient_barcode', 'eml4_alk_translocation_performed']]
...
for col in df.columns:  
    ...
    if patient_barcode in df2.index:
        histological_type = df2.at[patient_barcode, 'eml4_alk_translocation_performed']
